            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-3">
                    ...
                    <select name="referral_source" class="form-select">
                        ...
                        <option {{ old('referral_source') == 'Friend / Colleague' ? 'selected' : '' }}>Friend/Colleague</option>
                ...
                <div class="main-golf-info">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select input-uni @error('skill_level') is-invalid @enderror" name="skill_level" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select input-uni @error('fitness_level') is-invalid @enderror" name="fitness_level" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select input-uni @error('course_play_preference') is-invalid @enderror" name="course_play_preference" required>
                                <option value="" disabled selected>Select</option>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-12">
                            ...
                            value="{{ $c }}" {{ old('preferred_connection') == $c ? 'checked' : '' }}>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check">
                            <input type="radio" class="form-check-input" name="play_style" value="{{ $opt }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check">
                            <input type="radio" class="form-check-input" name="travel_radius" value="{{ $opt }}"
                        ...
                        <div class="col-md-6">
                            ...
                            value="{{ $opt }}" {{ old('handicafe_prefernce') == $opt ? 'checked' : '' }}>
                            <label class="form-check-label">{{ $opt }}</label>
                            </div>
                            @endforeach
                        ...
                        <div class="col-md-6">
                            ...
                            value="{{ $opt }}" {{ old('looking_for_prefernce') == $opt ? 'checked' : '' }}>
                            <label class="form-check-label">{{ $opt }}</label>
                            </div>
                            @endforeach
                        ...
                        <div class="col-md-6">
                            ...
                            value="{{ $opt }}" {{ old('course_play_prefernce') == $opt ? 'checked' : '' }}>
                            <label class="form-check-label">{{ $opt }}</label>
                            </div>
                            @endforeach
                        ...
                        <div class="col-md-6">
                            ...
                            value="{{ $opt }}" {{ old('skill_level_prefernce') == $opt ? 'checked' : '' }}>
                            <label class="form-check-label">{{ $opt }}</label>
                            </div>
                            @endforeach
                        ...
                        <div class="col-md-12">
                            ...
                            value="{{ $opt }}" {{ old('intrest_prefrence') == $opt ? 'checked' : '' }}>
                            <label class="form-check-label">{{ $opt }}</label>
                            </div>
                            @endforeach
