            ...
            <div class="card-uni">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="step" id="step1">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="bio" class="form-control @error('bio') is-invalid @enderror" placeholder="Share something..."
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select input-uni @error('fitness_level') is-invalid @enderror"
                                        ...
                                        <option value="Low" {{ old('fitness_level') == 'Low' ? 'selected' : '' }}>Low
                                        </option>
                                        <option value="Medium" {{ old('fitness_level') == 'Medium' ? 'selected' : '' }}>
                                            Medium</option>
                                        <option value="High" {{ old('fitness_level') == 'High' ? 'selected' : '' }}>High
                                        </option>
                                    </select>
                                    @error('fitness_level')
                                        <p class="text-danger">{{ $message }}</p>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select
                                        ...
                                        <option value="" disabled selected>Select</option>
                                        <option value="Walk"
                                            {{ old('course_play_preference') == 'Walk' ? 'selected' : '' }}>Walk</option>
                                        <option value="Cart"
                                            {{ old('course_play_preference') == 'Cart' ? 'selected' : '' }}>Cart</option>
                                        <option value="No Preference"
                                            {{ old('course_play_preference') == 'No Preference' ? 'selected' : '' }}>No
                                            Preference</option>
                                    </select>
                ...
                <div class="text-center mt-4">
                    <p class="mb-0" style="font-size:14px;color:var(--gray-600);">
                        ...
                        <a href="{{ route('login') }}" class="fw-semibold" style="color:var(--emerald);">
                            Sign in
                        </a>
                    </p>
                </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    /* ==================================================
       ✅ REAL FIX: Step-2 ke andar error text check
       ================================================== */
    const step2Errors = step2.querySelectorAll(".text-danger");
