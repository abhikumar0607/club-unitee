    ...
    <div class="blog-detail-page">
        ...
        <div class="container">
            ...
            <section class="blog-detail-hero">
                ...
                <img src="{{ asset('assets/admin/uploads/blogs/'.$blog_detail->image) }}" class="blog-detail-hero-img" alt="">
                @else
                  No Image found
                @endif  
                ...
                <div class="blog-detail-hero-content container">
                    ...
                    @endforeach
                        <span class="blog-detail-date">{{ \Carbon\Carbon::parse($blog_detail['publish_date'])->format('d M Y') }}</span>
                    </div>
