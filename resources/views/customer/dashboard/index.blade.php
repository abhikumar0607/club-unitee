            ...
            <div class="row g-4 mt-1">
                ...
                <div class="col-md-4">
                    <div class="card card-uni p-3">
                        ...
                        @else
                        <div class="event-img-sm mb-3 d-flex align-items-center justify-content-center no-image">No
                            Image Found</div>
                        @endif
                        ...
                        <p class="text-muted small mb-1">
                            @if($daysDiff <= 7) {{ $eventDate->format('l') }} •
                                {{ \Carbon\Carbon::parse($event->event_time)->format('h:i A') }} @else @if($daysDiff <
                                28) {{ ceil($daysDiff / 7) }} week {{ ceil($daysDiff / 7) > 1 ? 's' : '' }} later @else
                                {{ ceil($daysDiff / 30) }} month {{ ceil($daysDiff / 30) > 1 ? 's' : '' }} later @endif
                                @endif </p>
