  ...
  <section class="py-5 main-event-detail">
    <div class="container">
      ...
      <div class="card card-uni p-4">
        ...
        @if($daysDiff <= 7)
            {{ $eventDate->format('l') }} •
            {{ \Carbon\Carbon::parse($all_events->event_time)->format('h:i A') }}
        @else
            @if($daysDiff < 28)
        ...
        <!-- <div class="d-flex gap-3">
          ...
          <button class="btn btn-gradient px-4 w-25">Going</button>

          <button class="btn btn-outline-uni px-4 w-25">Maybe</button>

          <button class="btn btn-outline-uni px-4 w-25">Can't Go</button>
