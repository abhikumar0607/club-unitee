            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="all">
                        ...
                        <div class="col-md-4">
                            <div class="card card-uni p-3 text-center">
                                ...
                                <div class="member-photo mb-3">
                                    ...
                                    <img src="{{ asset('assets/customer/uploads/profile/' . $user->profile_image) }}"
                                ...
                                <hp class="text-muted mb-1">{{ $user->email }}</p>
                                    ...
                                    <div class="d-flex gap-2 mt-3">
                                        ...
                                        <a class="btn btn-gradient w-50"
                                            href="{{ route('customer.send.connection.request', $user->id) }}">
                                            Request Contact
                                        </a>
                                    </div>
                    ...
                    <div class="text-center py-5">
                        <img src="https://cdn-icons-png.flaticon.com/512/7486/7486740.png" width="120" class="mb-3">
                        ...
                        <div class="col-md-4">
                            <div class="card card-uni p-3 text-center">
                                ...
                                <hp class="text-muted mb-1">{{ $user->email }}</p>
                                    ...
                                    <p class="text-muted small">Connected {{ $user->created_at->diffForHumans() }}</p>
                                    <div class="mt-3">
                                        <a href="#" class="btn btn-outline-uni w-50">
                                            View
                                        </a>
                        ...
                        <div class="col-md-4">
                            <div class="card card-uni p-3 text-center">
                                <div class="member-photo mb-3">
                                    ...
                                    <img src="{{ asset('assets/customer/uploads/profile/' . $request->receiver->profile_image) }}"
                                        alt="Profile Image" class="rounded-circle"
                                        style="width:120px;height:120px;object-fit:cover;">
                                    @else
                                    <img src="{{ asset('assets/customer/images/person-dummy.jpg') }}"
                                ...
                                <hp class="text-muted mb-1">{{ $request->receiver->email }}</p>
                                    <p class="text-muted small mb-3">Request sent on
                                        {{ $request->receiver->created_at->diffForHumans() }}</p>
                                    <a href="{{ route('customer.cancel.connection.request', $request->id) }}"
                                        class="btn btn-outline-uni w-100">Cancel Request</a>
                            </div>
                        </div>
                        @endforeach
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="card card-uni p-3 text-center">
                                <div class="member-photo mb-3">
                                    ...
                                    <img src="{{ asset('assets/customer/uploads/profile/' . $re->sender->profile_image) }}"
                                        alt="Profile Image" class="rounded-circle"
                                        style="width:120px;height:120px;object-fit:cover;">
                                    @else
                                    <img src="{{ asset('assets/customer/images/person-dummy.jpg') }}"
                                ...
                                <hp class="text-muted mb-1">{{ $re->sender->email }}</p>
                                    ...
                                    <div class="d-flex gap-2">
                                        <a href="{{ route('customer.accept.connection.request', $re->id) }}"
                                            class="btn btn-gradient w-50">Accept</a>
                                        <a href="{{ route('customer.cancel.connection.request', $re->id) }}"
                                            class="btn btn-outline-uni w-50">Decline</a>
                                    </div>
                            </div>
                        </div>
                        @endforeach
