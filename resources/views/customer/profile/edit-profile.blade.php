...
<div class="main-content">
    ...
    <section class="pb-5">
        <div class="container">
            <form method="POST" action="{{ route('customer.dashboard.profile.update') }}" class="card card-uni p-4"
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="referral_source" id="referral_source" class="form-select">
                            ...
                            <option value="Member/Friend/Colleague"
                                {{ old('referral_source', $user->referral_source) == 'Member/Friend/Colleague' ? 'selected' : '' }}>
                                Member/Friend/Colleague</option>
                            <option value="LinkedIn"
                                {{ old('referral_source', $user->referral_source) == 'LinkedIn' ? 'selected' : '' }}>
                                LinkedIn</option>
                            <option value="Instagram"
                                {{ old('referral_source', $user->referral_source) == 'Instagram' ? 'selected' : '' }}>
                                Instagram</option>
                            <option value="Google Search"
                                {{ old('referral_source', $user->referral_source) == 'Google Search' ? 'selected' : '' }}>
                                Google Search
                            </option>
                            <option value="Other"
                                {{ old('referral_source', $user->referral_source) == 'Other' ? 'selected' : '' }}>Other
                            </option>
                        </select>
                    ...
                    <!---member name-->
                    <div class="col-md-6" id="memberNameDiv"
                        style="display: {{ old('referral_source', $user->referral_source) === 'Member/Friend/Colleague' ? 'block' : 'none' }};">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="bio" rows="4"
                        class="form-control input-uni input-bio">{{ old('bio', $user->bio) }}</textarea>
                    @error('bio')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4 form-check">
                        <input type="radio" class="form-check-input" name="availability" value="{{ $opt }}"
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4 form-check">
                        <input type="radio" class="form-check-input" name="looking_for" value="{{ $opt }}"
                ...
                <div class="row mb-4">
                    ...
                    <div class="form-check">
                        <input type="radio" class="form-check-input" name="preferred_connection" value="{{ $c }}"
                            {{ old('preferred_connection', $user->useravailability->preferred_connection ?? '') == $c ? 'checked' : '' }}>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-check">
                            <input type="radio" name="play_style" class="form-check-input" value="{{ $opt }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-check">
                            <input type="radio" name="travel_radius" class="form-check-input" value="{{ $opt }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-check">
                            <input type="radio" name="handicafe_prefernce" class="form-check-input" value="{{ $opt }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-check">
                            <input type="radio" name="looking_for_prefernce" class="form-check-input" value="{{ $opt }}"
                    ...
                    <div class="col-md-6">
                        ...
                        @foreach (['Walk', 'Cart', 'No Preference'] as $opt)
                        <div class="form-check">
                            <input type="radio" name="course_play_prefernce" class="form-check-input" value="{{ $opt }}"
                    ...
                    <div class="col-md-6">
                        ...
                        @foreach (['Beginner', 'Intermediate', 'Advanced'] as $opt)
                        <div class="form-check">
                            <input type="radio" name="skill_level_prefernce" class="form-check-input" value="{{ $opt }}"
                    ...
                    <div class="col-md-12">
                        ...
                        @foreach (['Casual Rounds', 'Lessons', 'Social Play', 'Competitive', 'Range Practice', 'No
                        Preference'] as $opt)
                        <div class="form-check">
                            <input type="radio" name="intrest_prefrence" class="form-check-input" value="{{ $opt }}"
