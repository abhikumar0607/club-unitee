        ...
        <div class="container">
            ...
            <div class="card card-uni p-4">
                ...
                <div class="row align-items-center">
                    <div class="col-md-3 text-center mb-4 mb-md-0">
                        <div class="profile-photo-view">
                            <img src="{{ $user->profile_image
                                    ...
                                    : asset('assets/customer/images/person-dummy.jpg') }}" class="rounded-circle"
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="d-flex flex-wrap gap-3 mt-3">
                            ...
                            <a href="{{ route('admin.application.approve', $user->id) }}" class="btn btn-gradient px-4">
                                Accept
                            </a>
                            <a href="{{ route('admin.application.reject', $user->id) }}"
                                class="btn btn-outline-uni px-4">
                                Decline
                            </a>
                            @elseif($user->is_approved == 'approved')
                            <a href="{{ route('admin.application.reject', $user->id) }}"
                                class="btn btn-outline-uni px-4">
                                Decline
                            </a>
                ...
                <div class="row g-4">
                    ...
                    <!-- ABOUT ME -->
                    <div class="col-md-6">
                        <h5 class="fw-bold mb-3 section-title-uni">About</h5>
