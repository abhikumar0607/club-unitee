        ...
        <div class="container">
            <div class="card card-uni p-4 mb-4">
                ...
                <form action="{{ route('admin.blogs') }}" method="GET">
                    <div class="row g-3">
                        <div class="col-md-3">
                            <input type="text" class="form-control input-uni" placeholder="Search by blog title"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="{{ route('admin.blogs.store') }}"
                                    enctype="multipart/form-data" id="createBlogForm">
                                    @csrf
                                    <!--Event Title-->
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div id="shortDescEditor" class="border rounded bg-white"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div id="descEditor" class="border rounded bg-white" style="min-height:220px;">
                                        </div>
