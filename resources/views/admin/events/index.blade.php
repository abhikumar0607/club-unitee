        ...
        <div class="container">
            <div class="card card-uni p-4 mb-4">
                ...
                <form action="{{ route('admin.events') }}" method="GET">
                    <div class="row g-3">
                        <div class="col-md-3">
                            <input type="text" class="form-control input-uni" placeholder="Search by event name"
                        ...
                        <div class="col-md-3">
                            <select class="form-select input-uni" name="type">
                                ...
                                <option value="Golf Outing" {{ request('type') == 'Golf Outing' ? 'selected' : '' }}>
                                    Golf Outing</option>
                                <option value="Social Event" {{ request('type') == 'Social Event' ? 'selected' : '' }}>
                                    Social Event</option>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-outline-uni btn-sm delete_event_record"
                                        data-event_id="{{ $event->id }}">Delete</a>
                                    <a href="{{ url('admin/events/rsvp/'.$event->id) }}"
                                        class="btn btn-outline-uni btn-sm">View RSVPs</a>
                                </td>
                            </tr>
                            @endforeach
                            @else
